...
class OneLayerAutoencoder(nn.Module):
    def __init__(self):
        ...
        self.enc = nn.Linear(in_features=1085, out_features=100)
        self.dec = nn.Linear(in_features=100, out_features=1085)
